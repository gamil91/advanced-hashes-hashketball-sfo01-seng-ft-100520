...
def num_points_scored (player_name)
  game_hash.each do |location, team|
    team.each do |team_details, details|
      if team_details == :players
        details.each do |player_stats|
...
rebounds = nil  
  game_hash.each do |location, team|
    team.each do |team_details, details|
     if team_details == :players
       details.each do |player_stats|
        if large_size == nil || large_size < player_stats[:shoe]
          large_size = player_stats[:shoe]
...
mvp = nil
  game_hash.each do |location, team|
    team.each do |team_details, details|
     if team_details == :players
       details.each do |player_stats|
        if points == nil || points < player_stats[:points]
...
def player_with_longest_name
  ...
  game_hash.each do |location, team|
    team.each do |team_details, details|
      if team_details == :players
        details.each do |player_stats|
          if longest_name == nil || longest_name.length < player_stats[:player_name].length 
    ...
    team.each do |team_details, details|
     if team_details == :players
       details.each do |player_stats|
        ...
        if player_stats[:player_name] == player_with_longest_name
           steals = player_stats[:steals]
        end 
        
        all_steals << player_stats[:steals]
        
       end
      end
    end
  end
all_steals.max == steals
end
